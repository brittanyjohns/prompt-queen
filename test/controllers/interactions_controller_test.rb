...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference("Interaction.count") do
      post interactions_url, params: { interaction: { name: @interaction.name, type: @interaction.type, user_id: @interaction.user_id } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { name: @interaction.name, type: @interaction.type, user_id: @interaction.user_id } }

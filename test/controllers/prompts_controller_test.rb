...
class PromptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prompt" do
    assert_difference("Prompt.count") do
      post prompts_url, params: { prompt: { body: @prompt.body, created_by: @prompt.created_by, prompt_template_id: @prompt.prompt_template_id } }
    end
  ...
  test "should update prompt" do
    patch prompt_url(@prompt), params: { prompt: { body: @prompt.body, created_by: @prompt.created_by, prompt_template_id: @prompt.prompt_template_id } }
